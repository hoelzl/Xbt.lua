...
function t.test_floyd ()
  ...
  local gen = graph.make_short_edge_generator(1)
  local g = graph.generate_graph(nodes, 0, gen)
  local rewards,next = graph.floyd(g)
  assert_equal(rewards, g.rewards)
  assert_equal(next, g.next)
  assert_equal(-2, rewards[1][1])
  assert_equal(-1, rewards[1][2])
  assert_equal(-1, rewards[1][3])
  assert_equal(-2, rewards[1][4])
  assert_equal(-1, rewards[2][1])
  assert_equal(-2, rewards[2][2])
  assert_equal(-2, rewards[2][3])
  assert_equal(-3, rewards[2][4])
  assert_equal(-1, rewards[3][1])
  assert_equal(-2, rewards[3][2])
  assert_equal(-2, rewards[3][3])
  assert_equal(-1, rewards[3][4])
  assert_equal(-2, rewards[4][1])
  assert_equal(-3, rewards[4][2])
  assert_equal(-1, rewards[4][3])
  assert_equal(-2, rewards[4][4])
...
function t.test_absolute_difference ()
  ...
  graph.floyd(gc)
  assert_equal(0, graph.absolute_difference(g.rewards, g.rewards))
  assert_true(graph.absolute_difference(g.rewards, gc.rewards) > 0)
end
